#ifndef SEIGETOWERATTACK_H
#define SEIGETOWERATTACK_H
...
private:
    ...
    void destroyWall(vector<b2Vec2>&, vector<float32>&, vector<b2Vec2>&,  vector<float32>&, vector<b2Vec2>&,  vector<float32>&, vector<b2Vec2>&,  vector<float32>&, vector<b2Vec2>&,  vector<float32>&);
    b2Body* createBody(float, float);
    float siegeTowerStartingX;
